...
HD_PWD='/home/lukas/fpga_vivado/projects/trafficlights/trafficlights.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log trafficlight.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source trafficlight.tcl -notrace
