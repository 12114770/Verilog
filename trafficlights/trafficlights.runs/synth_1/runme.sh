...
HD_PWD='/home/lukas/fpga_vivado/projects/trafficlights/trafficlights.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trafficlight.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trafficlight.tcl
