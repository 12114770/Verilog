...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../trafficlights.gen/sources_1/ip/ila_1/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../trafficlights.gen/sources_1/ip/ila_1/hdl/verilog" \
