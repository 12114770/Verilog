...
#
# Script generated by Vivado on Wed Jan 08 16:41:39 CET 2025
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../trafficlights.gen/sources_1/ip/ila_1/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../trafficlights.gen/sources_1/ip/ila_1/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/lukas/fpga_vivado/projects/trafficlights/trafficlights.cache/compile_simlib/vcs"
  fi
