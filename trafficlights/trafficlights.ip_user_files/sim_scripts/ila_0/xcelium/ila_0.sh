...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../trafficlights.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../trafficlights.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/lukas/fpga_vivado/projects/trafficlights/trafficlights.cache/compile_simlib/xcelium"
  fi
