...
HD_PWD='/home/lukas/fpga_vivado/projects/seg_display_driver/seg_display_driver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_display_driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seg_display_driver.tcl -notrace
