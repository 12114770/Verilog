...
HD_PWD='/home/lukas/fpga_vivado/projects/seg_display_driver/seg_display_driver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_display_driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seg_display_driver.tcl
