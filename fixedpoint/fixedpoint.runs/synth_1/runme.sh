...
HD_PWD='/home/lukas/fpga_vivado/projects/fixedpoint/fixedpoint.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fixedpoint.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fixedpoint.tcl
