...
ARCHITECTURE rtl OF ov7670_capture IS
    ...
    TYPE reg_type IS RECORD
        ...
        bram_address : unsigned(16 DOWNTO 0);
    END RECORD reg_type;
        ...
        CASE reg.state IS
            ...
            WHEN capture_rgb_byte =>
                IF pclk_edge = '1' THEN
                    ...
                    IF (reg.pixel_reg MOD 4 = 0) THEN
                        reg_next.state <= write_to_bram; -- Only write every 4th pixel
                    ELSE
                        reg_next.state <= capture_line; -- Skip writing this pixel
                    END IF;
                END IF;
            ...
            WHEN write_to_bram =>
                ...
                ELSE
                    reg_next.bram_address <= reg.bram_address;
                END IF;
