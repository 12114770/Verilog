...
HD_PWD='/home/lukas/fpga_vivado/projects/ec_encryption/ec_encryption.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sha256.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sha256.tcl -notrace
